...
// ITANIUM: [[F_TPTR]] = !{i64 0, !"_ZTSFPvS_S_S_E.generalized"}
// ITANIUM: [[F_TPRIMITIVE_CT]] = !{[[F_TPRIMITIVE:![0-9]+]]}
// ITANIUM: [[F_TPTR_CT]] = !{[[F_TPTR:![0-9]+]]}
// ITANIUM: [[F_TSTRUCT]] = !{i64 0, !"_ZTSFv3st2PvE.generalized"}
...
// MS: [[F_TPTR]] = !{i64 0, !"?6APEAXPEAX00@Z.generalized"}
// MS: [[F_TPRIMITIVE_CT]] = !{[[F_TPRIMITIVE:![0-9]+]]}
// MS: [[F_TPTR_CT]] = !{[[F_TPTR:![0-9]+]]}
// MS: [[F_TSTRUCT]] = !{i64 0, !"?6AXUst2@@PEAX@Z.generalized"}
