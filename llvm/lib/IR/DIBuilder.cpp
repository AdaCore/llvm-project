...
DIDerivedType *DIBuilder::createVariantMemberType(DIScope *Scope,
                                                  ...
                                                  DIType *Ty) {
  auto *V =
      DICompositeType::get(VMContext, dwarf::DW_TAG_variant, {}, nullptr, 0,
                           getNonCompileUnitScope(Scope), {}, (uint64_t)0, 0, (uint64_t)0,
                           DINode::FlagZero, Elements, 0, nullptr, nullptr, {});
