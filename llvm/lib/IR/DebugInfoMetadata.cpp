...
DISubrangeType::DISubrangeType(LLVMContext &C, StorageType Storage,
                               unsigned Line, uint32_t AlignInBits, DIFlags Flags,
                               ArrayRef<Metadata *> Ops)
...
DIBasicType *DIBasicType::getImpl(LLVMContext &Context, unsigned Tag,
  ...
  DEFINE_GETIMPL_STORE(DIBasicType,
                       (Tag, AlignInBits, Encoding, Flags), Ops);
}
...
DICompositeType *DICompositeType::getImpl(
  ...
  Metadata *Ops[] = {File,          Scope,        Name,           SizeInBits,
                     OffsetInBits,  BaseType,
                     Elements,      VTableHolder, TemplateParams, Identifier,
                     Discriminator, DataLocation, Associated,     Allocated,
                     Rank,          Annotations,  BitStride};
  DEFINE_GETIMPL_STORE(
      DICompositeType,
      (Tag, Line, RuntimeLang, AlignInBits, Flags),
      Ops);
}
...
DICompositeType *DICompositeType::buildODRType(
  ...
  CT->mutate(Tag, Line, RuntimeLang, AlignInBits, Flags);
  Metadata *Ops[] = {File,          Scope,        Name,           SizeInBits,
                     OffsetInBits,  BaseType,
                     Elements,      VTableHolder, TemplateParams, &Identifier,
                     Discriminator, DataLocation, Associated,     Allocated,
