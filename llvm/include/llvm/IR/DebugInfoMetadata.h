...
public:
  ...
  StringRef getIdentifier() const { return getStringOperand(MY_FIRST_OPERAND + 4); }
  unsigned getRuntimeLang() const { return RuntimeLang; }

  Metadata *getRawBaseType() const { return getOperand(MY_FIRST_OPERAND); }
  Metadata *getRawElements() const { return getOperand(MY_FIRST_OPERAND + 1); }
  Metadata *getRawVTableHolder() const { return getOperand(MY_FIRST_OPERAND + 2); }
  Metadata *getRawTemplateParams() const { return getOperand(MY_FIRST_OPERAND + 3); }
  MDString *getRawIdentifier() const { return getOperandAs<MDString>(MY_FIRST_OPERAND + 4); }
  Metadata *getRawDiscriminator() const { return getOperand(MY_FIRST_OPERAND + 5); }
  DIDerivedType *getDiscriminator() const {
    return getOperandAs<DIDerivedType>(MY_FIRST_OPERAND + 5);
  }
  Metadata *getRawDataLocation() const { return getOperand(MY_FIRST_OPERAND + 6); }
  ...
  Metadata *getRawAssociated() const { return getOperand(MY_FIRST_OPERAND + 7); }
  ...
  Metadata *getRawAnnotations() const { return getOperand(MY_FIRST_OPERAND + 10); }
  DINodeArray getAnnotations() const {
    return cast_or_null<MDTuple>(getRawAnnotations());
  }

  Metadata *getRawBitStride() const { return getOperand(MY_FIRST_OPERAND + 11); }
