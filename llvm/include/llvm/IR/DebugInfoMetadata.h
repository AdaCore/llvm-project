...
protected:
  ...
  static DIBasicType *getImpl(LLVMContext &Context, unsigned Tag,
    ...
    return getImpl(Context, Tag, Name, File, LineNo, Scope, SizeInBitsNode,
                   AlignInBits, Encoding, NumExtraInhabitants, Flags, Storage,
                   ShouldCreate);
  }
  ...
  getImpl(LLVMContext &Context, unsigned Tag, MDString *Name, Metadata *File,
          ...
          DIFlags Flags, StorageType Storage, bool ShouldCreate = true);
...
public:
  DEFINE_MDNODE_GET(DIBasicType, (unsigned Tag, StringRef Name),
                    (Tag, Name, nullptr, 0, nullptr, 0, 0, 0, 0, FlagZero))
  DEFINE_MDNODE_GET(DIBasicType,
                    (unsigned Tag, StringRef Name, uint64_t SizeInBits),
                    (Tag, Name, nullptr, 0, nullptr, SizeInBits, 0, 0, 0,
                     FlagZero))
  DEFINE_MDNODE_GET(DIBasicType,
